...
- The parent Plugin has no Required Service and provides no Runtime Service. A failed Composition is terminal for that Installation and must be disposed before a new one is installed; the preset does not silently retry.
