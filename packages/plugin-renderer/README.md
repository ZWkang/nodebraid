...
> Documentation: [English](https://zwkang.github.io/nodebraid/en/modules/plugin-renderer) · [简体中文](https://zwkang.github.io/nodebraid/modules/plugin-renderer)

Runtime integration for NodeBraid Renderer Providers.
