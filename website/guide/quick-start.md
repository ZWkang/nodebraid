...
如果需要 Kernel、Command、Session、Renderer、Interaction 与 History 的完整基础组合，可以显式选择 SVG Provider 并安装 [`@nodebraid/preset-basic`](/modules/preset-basic)。下面的 canonical example 与真实 Chromium 验收共用同一份源码：
